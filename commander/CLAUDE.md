...
- Gradle-Wrapper ist auf die stabile Version `8.11.1` gepinnt (nicht auf einen neueren Milestone-/Preview-Build) – `AGP 8.9.0` ist offiziell erst ab `8.11.1` getestet; ein Gradle-9.0-Milestone-Build erzeugte deprecation-Warnungen, weil AGP 8.9 intern noch APIs nutzt, die dieser Preview bereits als deprecated markiert. Sobald AGP angehoben wird, kann auch der Gradle-Wrapper mit angehoben werden.
