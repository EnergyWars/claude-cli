...
Sobald ein Server gefunden ist, listet die App alle über `GET /collections` gemeldeten Dateien auf (Name + Zeitpunkt der letzten Änderung in der Zeitzone des Geräts, neueste zuerst). Ohne Dateien erscheint ein Leer-Hinweis. Kehrt man aus dem Hintergrund in die App zurück oder öffnet sie erneut, wird die Liste automatisch neu geladen – kein manuelles Aktualisieren nötig.
